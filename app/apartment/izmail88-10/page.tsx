export default function ApartmentPage() {
  const images = [
    "/apartments/izmail88-10/1.png",
    "/apartments/izmail88-10/2.png",
    "/apartments/izmail88-10/3.png",
    "/apartments/izmail88-10/4.png",
    "/apartments/izmail88-10/5.png",
  ];
      ...
      <header className="sticky top-0 z-40 border-b border-black/5 bg-white/95 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="hidden items-center gap-3 lg:flex">
            ...
            <a
              href="https://wa.me/37369990190?text=Здравствуйте! Интересует квартира Измаил 88, ID 10"
              target="_blank"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {galleryImages.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Фото квартиры ID 10 ${index + 1}`}
                    loading="lazy"
