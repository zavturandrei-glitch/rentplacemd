export default function ApartmentPage() {
  const images = [
    "/apartments/izmail88-13/1.png",
    "/apartments/izmail88-13/2.png",
    "/apartments/izmail88-13/3.png",
    "/apartments/izmail88-13/4.png",
      ...
      <header className="sticky top-0 z-40 border-b border-black/5 bg-white/95 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="hidden items-center gap-3 lg:flex">
            ...
            <a
              href="https://wa.me/37369990190?text=Здравствуйте! Интересует квартира Измаил 88, ID 13"
              target="_blank"
          ...
          <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
            <div className="flex flex-col justify-center p-6 text-white sm:p-9 lg:p-10">
              ...
              <p className="mt-5 max-w-xl text-lg leading-8 text-white/75">
                Просторная квартира 2+1 в центре Кишинёва. Две отдельные
                спальни, две двуспальные кровати, кухня и комфортное размещение
                до 4 гостей.
              </p>

              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                <div className="rounded-3xl bg-white p-5 text-[#111827]">
                  <p className="text-4xl font-black text-[#d4146f]">900</p>
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-3">
          <div className="rounded-[36px] bg-white p-6 shadow-lg sm:p-9 lg:col-span-2">
            ...
            <h2 className="mt-3 text-3xl font-black sm:text-4xl">
              Удобный вариант с двумя спальнями
            </h2>

            <p className="mt-5 text-lg leading-8 text-gray-700">
              Просторная квартира 2+1 в центре Кишинёва, комплекс Измаил 88.
              В квартире две отдельные спальни с двуспальными кроватями,
              оборудованная кухня, чистое бельё, Wi-Fi, кондиционер и всё
              необходимое для комфортного проживания.
            </p>

            <p className="mt-5 text-lg leading-8 text-gray-700">
              Хорошо подходит для семьи, двух пар или гостей в командировке,
              которым важно жить в центре и иметь отдельные спальные места.
            </p>
          ...
          <aside className="rounded-[36px] bg-[#d4146f] p-6 text-white shadow-xl sm:p-8 lg:sticky lg:top-28 lg:h-fit">
            ...
            <p className="mt-4 text-6xl font-black">900</p>
