    ...
    <main className="min-h-screen bg-[#f7f7f8] text-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="mb-8 flex flex-col items-start justify-between gap-6 md:flex-row">
          <div>
            ...
            <p className="mt-3 text-xl font-bold text-gray-600">
              Центр • 2+1 • 2 отдельные спальни • До 4 гостей
            </p>
          </div>

          <div className="rounded-3xl bg-white p-6 shadow-lg">
            <p className="text-5xl font-black text-[#d4146f]">от 900 лей</p>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <img
            src="/apartments/izmail88-13/1.png"
            alt="Спальня 1"
            className="h-[450px] w-full rounded-3xl object-cover shadow-lg"
          />
          <img
            src="/apartments/izmail88-13/2.png"
            alt="Спальня 2"
            className="h-[450px] w-full rounded-3xl object-cover shadow-lg"
          />
          <img
            src="/apartments/izmail88-13/3.png"
            alt="Кухня"
            className="h-[450px] w-full rounded-3xl object-cover shadow-lg"
          />
          <img
            src="/apartments/izmail88-13/4.png"
            alt="Прихожая"
            className="h-[450px] w-full rounded-3xl object-cover shadow-lg"
          />
          <img
            src="/apartments/izmail88-13/5.png"
            alt="Ванная"
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          <div className="rounded-3xl bg-white p-8 shadow-lg md:col-span-2">
            ...
            <p className="mt-5 text-lg leading-8 text-gray-700">
              ...
              Две отдельные спальни с двуспальными кроватями, гостиная зона и
              оборудованная кухня. Отличный вариант для семьи, двух пар или
              гостей в командировке.
            </p>

            <p className="mt-5 text-lg leading-8 text-gray-700">
              В квартире есть всё необходимое для комфортного проживания:
              чистое бельё, Wi-Fi, кондиционер, кухня, техника и быстрое
              заселение 24/7.
            </p>
