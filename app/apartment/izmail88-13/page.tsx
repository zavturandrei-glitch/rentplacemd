      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-8">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-6">
            <p className="text-5xl font-black text-[#d4146f]">45 €</p>
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <img src="/apartments/izmail88-20/living2.png" alt="Гостиная" className="w-full h-[450px] object-cover rounded-3xl shadow-lg" />
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-10">
          <div className="md:col-span-2 bg-white rounded-3xl shadow-lg p-8">
            ...
            <p className="mt-5 text-lg text-gray-700 leading-8">
              ...
              отдельная спальня, современный ремонт, чистое бельё и всё необходимое
