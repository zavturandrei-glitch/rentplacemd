    ...
    <main className="min-h-screen bg-[#f7f7f8] text-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <img
            src="/apartments/izmail88-20/1.png"
            alt="Фото квартиры 1"
            className="h-[450px] w-full rounded-3xl object-cover shadow-lg"
          />
          <img
            src="/apartments/izmail88-20/2.png"
            alt="Фото квартиры 2"
            className="h-[450px] w-full rounded-3xl object-cover shadow-lg"
          />
          <img
            src="/apartments/izmail88-20/3.png"
            alt="Фото квартиры 3"
            className="h-[450px] w-full rounded-3xl object-cover shadow-lg"
          />
          <img
            src="/apartments/izmail88-20/4.png"
            alt="Фото квартиры 4"
            className="h-[450px] w-full rounded-3xl object-cover shadow-lg"
          />
          <img
            src="/apartments/izmail88-20/5.png"
            alt="Фото квартиры 5"
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          <div className="rounded-3xl bg-white p-8 shadow-lg md:col-span-2">
            ...
            <p className="mt-5 text-lg leading-8 text-gray-700">
              Просторная квартира в центре Кишинёва. Большая кухня-ливинг,
              отдельная спальня, современный ремонт, чистое бельё и всё
