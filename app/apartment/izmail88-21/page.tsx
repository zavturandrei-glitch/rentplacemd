    ...
    <main className="min-h-screen bg-[#f7f7f8] text-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="mb-8 flex flex-col items-start justify-between gap-6 md:flex-row">
          <div>
            ...
            <p className="mt-3 text-xl text-gray-600">
              1-комнатная квартира • Центр • До 4 гостей
            </p>
          </div>

          <div className="rounded-3xl bg-white p-6 shadow-lg">
            <p className="text-5xl font-black text-[#d4146f]">от 800 лей</p>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <img
            src="/apartments/izmail88-21/1.png"
            alt="Фото квартиры ID 21"
            className="h-[450px] w-full rounded-3xl object-cover shadow-lg"
          />
          <img
            src="/apartments/izmail88-21/2.png"
            alt="Фото квартиры ID 21"
            className="h-[450px] w-full rounded-3xl object-cover shadow-lg"
          />
          <img
            src="/apartments/izmail88-21/3.png"
            alt="Фото квартиры ID 21"
            className="h-[450px] w-full rounded-3xl object-cover shadow-lg"
          />
          <img
            src="/apartments/izmail88-21/4.png"
            alt="Фото квартиры ID 21"
            className="h-[450px] w-full rounded-3xl object-cover shadow-lg"
          />
          <img
            src="/apartments/izmail88-21/5.png"
            alt="Фото квартиры ID 21"
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          <div className="rounded-3xl bg-white p-8 shadow-lg md:col-span-2">
            ...
            <p className="mt-5 text-lg leading-8 text-gray-700">
              Полноценная однокомнатная квартира в центре Кишинёва, в комплексе
              Измаил 88. В квартире есть большая двуспальная кровать и
              раскладной диван. Подходит для 2, 3 или 4 гостей. Есть кухня,
              ванная комната, стиральная машина и всё необходимое для
