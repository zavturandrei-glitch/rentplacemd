export default function ApartmentPage() {
  const images = [
    "/apartments/izmail88-42/1.png",
    "/apartments/izmail88-42/2.png",
    "/apartments/izmail88-42/3.png",
    "/apartments/izmail88-42/4.png",
  ];
      ...
      <header className="sticky top-0 z-40 border-b border-black/5 bg-white/95 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="hidden items-center gap-3 lg:flex">
            ...
            <a
              href="https://wa.me/37369990190?text=Здравствуйте! Интересует квартира Измаил 88, ID 42"
              target="_blank"
          ...
          <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
            <div className="flex flex-col justify-center p-6 text-white sm:p-9 lg:p-10">
              ...
              <p className="mt-5 max-w-xl text-lg leading-8 text-white/75">
                Просторная квартира 2+1 в центре Кишинёва. Две раздельные
                спальни, большой living, кухня и комфортное размещение до 5
                гостей.
              </p>

              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                <div className="rounded-3xl bg-white p-5 text-[#111827]">
                  <p className="text-4xl font-black text-[#d4146f]">1000</p>
        ...
        <section className="mt-8">
          ...
          <div className="mt-5 grid gap-4 lg:grid-cols-12">
            ...
            <div className="overflow-hidden rounded-[32px] bg-white p-2 shadow-lg lg:col-span-3">
              <img
                src={images[2]}
                alt="Вторая спальня ID 42"
                loading="lazy"
                className="h-[260px] w-full rounded-[26px] object-cover sm:h-[330px]"
              />
            </div>

            <div className="overflow-hidden rounded-[32px] bg-white p-2 shadow-lg lg:col-span-6">
              <img
                src={images[3]}
                alt="Ванная ID 42"
                loading="lazy"
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-3">
          <div className="rounded-[36px] bg-white p-6 shadow-lg sm:p-9 lg:col-span-2">
            ...
            <h2 className="mt-3 text-3xl font-black sm:text-4xl">
              Просторный вариант для семьи или компании
            </h2>
            ...
            <p className="mt-5 text-lg leading-8 text-gray-700">
              Отличный вариант для семьи, гостей города или командировки. Дом
              находится в центре, рядом удобно добираться до нужных точек города.
            </p>
          ...
          <aside className="rounded-[36px] bg-[#d4146f] p-6 text-white shadow-xl sm:p-8 lg:sticky lg:top-28 lg:h-fit">
            ...
            <p className="mt-4 text-6xl font-black">1000</p>
