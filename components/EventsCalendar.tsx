...
const ui: Record<Language, {
  ...
  ru: {
    ...
    apartments: "Квартиры посуточно в Кишинёве",
  ...
  ro: {
    ...
    apartments: "Apartamente în regim hotelier în Chișinău",
  ...
  en: {
    ...
    apartments: "Short-stay apartments in Chisinau",
  ...
  uk: {
    ...
    apartments: "Квартири подобово в Кишиневі",
  ...
  cs: {
    ...
    apartments: "Krátkodobé pronájmy v Kišiněvě",
