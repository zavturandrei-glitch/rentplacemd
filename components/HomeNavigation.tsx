...
> = {
  ru: {
    ...
    cards: {
      ...
      guide: { title: "Гид по Кишинёву", text: "Места и идеи для поездки", alt: "Кафедральный собор Кишинёва в солнечный день" },
  ...
  ro: {
    ...
    cards: {
      ...
      guide: { title: "Ghidul Chișinăului", text: "Locuri și idei pentru călătorie", alt: "Catedrala Mitropolitană din Chișinău într-o zi însorită" },
  ...
  en: {
    ...
    cards: {
      ...
      guide: { title: "Chișinău guide", text: "Places and ideas for your trip", alt: "Chișinău Metropolitan Cathedral on a sunny day" },
  ...
  uk: {
    ...
    cards: {
      ...
      guide: { title: "Гід по Кишиневу", text: "Місця та ідеї для подорожі", alt: "Кафедральний собор Кишинева в сонячний день" },
  ...
  cs: {
    ...
    cards: {
      ...
      guide: { title: "Průvodce Kišiněvem", text: "Místa a tipy na cestu", alt: "Metropolitní katedrála v Kišiněvě za slunečného dne" },
...
const cardDefinitions: Array<{
  ...
  { key: "quick", image: "/apartments/coca-15-204/1.jpg", position: "center 57%", tone: "bg-[#D4146F]", textTone: "text-white" },
  { key: "catalog", href: "/apartments", image: "/apartments/mihai-eminescu-76-me-76/1.jpg", tone: "bg-[#FFD21F]", textTone: "text-[#07111F]" },
  { key: "about", href: "/about", image: "/service-pages/about-apartment.webp", tone: "bg-[#25D366]", textTone: "text-[#062514]" },
            ...
            const content = (
              <>
                ...
                <span className="flex min-h-0 flex-1 flex-col px-3 py-1.5 sm:px-4 sm:py-2">
                  <strong className={`${card.key === "owners" ? "text-[11.5px] min-[390px]:text-[12.5px]" : "text-[12px] min-[390px]:text-[13px]"} font-black leading-[1.04] tracking-[-0.02em] sm:text-[15px]`}>
                    {cardCopy.title}
                  </strong>
