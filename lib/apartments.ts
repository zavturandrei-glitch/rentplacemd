...
export const apartments = [
  ...
  createApartment({
    ...
    kind: "studio",
    shortDescription:
      "Свежая студия Standard+ с видом во двор, мини-кухней, кондиционером и Wi-Fi.",
    fullDescription:
      "Студия ID 201 на Strada Coca 15 подготовлена для посуточного проживания. Спокойный вид во двор и цена 800 MDL делают её практичным вариантом для поездки в Кишинёв.\n\nВ студии выполнен современный евроремонт. Подтверждённое оснащение: кондиционер, Wi-Fi, роллеты, мини-кухня и обычный телевизор.",
    amenities: [
      "Standard+",
  ...
  createApartment({
    ...
    kind: "studio",
    shortDescription:
      "Современная студия Standard+ с видом в сторону Дендрария и оснащением для посуточного проживания.",
    fullDescription:
      "Студия ID 202 на Strada Coca 15 обращена в сторону Дендрария. Свежий интерьер и цена 900 MDL подходят для короткой остановки или более длительного пребывания.\n\nПодтверждённое оснащение включает кондиционер, Smart TV, Wi-Fi, роллеты и мини-кухню.",
    amenities: [
      "Standard+",
      "Современный евроремонт",
      "Кондиционер",
