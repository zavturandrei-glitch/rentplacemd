...
> = {
  ru: {
    coca: "Фасад здания Coca 15 в Кишинёве",
    varlaam: "Фасад двухэтажного здания на Strada Mitropolit Varlaam 50 в Кишинёве",
  },
  ro: {
  ...
  uk: {
    coca: "Фасад будівлі Coca 15 у Кишиневі",
    varlaam: "Фасад двоповерхової будівлі на Strada Mitropolit Varlaam 50 у Кишиневі",
  },
  cs: {
...
const newApartmentCopy: Record<Language, Record<string, ApartmentCopy>> = {
  ru: {
    "201": {
      address: "Strada Coca 15, Кишинёв",
      title: "Студия Standard+ на Strada Coca 15 — ID 201",
      description: "Студия Standard+ на Strada Coca 15 в Кишинёве с видом во двор, кондиционером, Wi‑Fi, роллетами и мини-кухней. 800 MDL в сутки.",
      shortDescription: "Свежая студия с видом во двор и практичным оснащением для посуточного проживания.",
      aboutTitle: "Спокойная студия Standard+ на Strada Coca 15",
      typeLabel: "Студия Standard+",
      view: "Вид во двор",
      features: ["Standard+", "Современный евроремонт", "Кондиционер", "Wi‑Fi", "Роллеты", "Мини-кухня", "Телевизор", "Вид во двор"],
    ...
    "202": {
      ...
      description: "Студия Standard+ на Strada Coca 15 с видом в сторону Дендрария, Smart TV, кондиционером, Wi‑Fi и мини-кухней. 900 MDL в сутки.",
      shortDescription: "Современная студия Standard+ с видом в сторону Дендрария.",
      aboutTitle: "Студия Standard+ рядом с Дендрарием",
      typeLabel: "Студия Standard+",
      view: "Вид в сторону Дендрария",
      features: ["Standard+", "Современный евроремонт", "Кондиционер", "Smart TV", "Wi‑Fi", "Роллеты", "Мини-кухня", "Вид в сторону Дендрария"],
      descriptionParagraphs: [
        "ID 202 — свежая студия на Strada Coca 15 с окнами в сторону зелёной территории Дендрария. Интерьер подготовлен для удобного посуточного проживания.",
    ...
    "203": {
      ...
      description: "Premium-студия на Strada Coca 15 с современным интерьером, видом в сторону Дендрария, Smart TV, Wi‑Fi и кондиционером. 1000 MDL в сутки.",
      shortDescription: "Выразительная Premium-студия с цельным интерьером и видом в сторону Дендрария.",
      aboutTitle: "Premium-студия ID 203 на Strada Coca 15",
    ...
    "204": {
      ...
      description: "Светлая студия Premium на Strada Coca 15 с видом в сторону Дендрария, кондиционером, Smart TV, Wi‑Fi и мини-кухней. 1000 MDL в сутки.",
    ...
    "205": {
      address: "Strada Mitropolit Varlaam 50, Кишинёв",
      title: "Апартамент в двухэтажном доме на Varlaam 50 — ID 205",
      description: "Отдельный апартамент Standard+ в двухэтажном здании на Strada Mitropolit Varlaam 50. Новый интерьер, посуточное проживание, 1100 MDL.",
      shortDescription: "Отдельный апартамент с новым интерьером в двухэтажном здании, разделённом на самостоятельные апартаменты.",
      aboutTitle: "Отдельный апартамент на Strada Mitropolit Varlaam 50",
      typeLabel: "Отдельный апартамент",
      view: "Отдельный апартамент в двухэтажном здании",
      features: ["Standard+", "Отдельный апартамент", "Двухэтажное здание", "Новый современный интерьер", "Подготовлен для посуточного проживания"],
      descriptionParagraphs: [
  ...
  ro: {
    "201": {
      ...
      title: "Garsonieră Standard+ pe Strada Coca 15 — ID 201",
      description: "Garsonieră Standard+ pe Strada Coca 15, cu vedere spre curte, aer condiționat, Wi‑Fi, rulouri și mini-bucătărie. 800 MDL pe noapte.",
      shortDescription: "Garsonieră renovată, cu vedere liniștită spre curte și dotări practice pentru șederi zilnice.",
      aboutTitle: "Garsonieră liniștită Standard+ pe Strada Coca 15",
      typeLabel: "Garsonieră Standard+",
      view: "Vedere spre curte",
      features: ["Standard+", "Renovare modernă", "Aer condiționat", "Wi‑Fi", "Rulouri", "Mini-bucătărie", "Televizor", "Vedere spre curte"],
      descriptionParagraphs: [
    ...
    "202": {
      ...
      description: "Garsonieră Standard+ pe Strada Coca 15, cu vedere spre Dendrariu, Smart TV, aer condiționat, Wi‑Fi și mini-bucătărie. 900 MDL.",
      shortDescription: "Garsonieră modernă Standard+ cu vedere în direcția Dendrariului.",
      aboutTitle: "Garsonieră Standard+ lângă Dendrariu",
      typeLabel: "Garsonieră Standard+",
      view: "Vedere în direcția Dendrariului",
      features: ["Standard+", "Renovare modernă", "Aer condiționat", "Smart TV", "Wi‑Fi", "Rulouri", "Mini-bucătărie", "Vedere spre Dendrariu"],
      descriptionParagraphs: [
    ...
    "205": {
      ...
      description: "Apartament separat Standard+ într-o clădire cu două niveluri pe Strada Mitropolit Varlaam 50. Interior nou, 1100 MDL pe noapte.",
      ...
      features: ["Standard+", "Apartament separat", "Clădire cu două niveluri", "Interior modern nou", "Pregătit pentru închiriere zilnică"],
      descriptionParagraphs: [
  ...
  en: {
    "201": {
      ...
      title: "Standard+ studio at 15 Coca Street — ID 201",
      description: "Standard+ studio at 15 Coca Street with a courtyard view, air conditioning, Wi‑Fi, roller shutters and kitchenette. 800 MDL per night.",
      shortDescription: "Freshly renovated studio with a quiet courtyard view and practical short-stay amenities.",
      aboutTitle: "Quiet Standard+ studio at 15 Coca Street",
      typeLabel: "Standard+ studio",
      view: "Courtyard view",
      features: ["Standard+", "Modern renovation", "Air conditioning", "Wi‑Fi", "Roller shutters", "Kitchenette", "Television", "Courtyard view"],
      descriptionParagraphs: [
    ...
    "202": {
      ...
      description: "Standard+ studio at 15 Coca Street facing Dendrarium, with Smart TV, air conditioning, Wi‑Fi and a kitchenette. 900 MDL per night.",
      shortDescription: "Modern Standard+ studio with a view in the direction of Dendrarium Park.",
      aboutTitle: "Standard+ studio near Dendrarium",
      typeLabel: "Standard+ studio",
      view: "View towards Dendrarium",
      features: ["Standard+", "Modern renovation", "Air conditioning", "Smart TV", "Wi‑Fi", "Roller shutters", "Kitchenette", "View towards Dendrarium"],
      descriptionParagraphs: [
    ...
    "205": {
      ...
      description: "Separate Standard+ apartment in a two-storey property at 50 Mitropolit Varlaam Street. New interior, 1100 MDL per night.",
      ...
      features: ["Standard+", "Separate apartment", "Two-storey property", "New modern interior", "Prepared for daily stays"],
      descriptionParagraphs: [
  ...
  uk: {
    "201": {
      address: "Strada Coca 15, Кишинів",
      title: "Студія Standard+ на Strada Coca 15 — ID 201",
      description: "Студія Standard+ на Strada Coca 15 з видом у двір, кондиціонером, Wi‑Fi, ролетами та міні-кухнею. 800 MDL за добу.",
      shortDescription: "Оновлена студія зі спокійним видом у двір і практичним оснащенням для подобового проживання.",
      aboutTitle: "Тиха студія Standard+ на Strada Coca 15",
      typeLabel: "Студія Standard+",
      view: "Вид у двір",
      features: ["Standard+", "Сучасний євроремонт", "Кондиціонер", "Wi‑Fi", "Ролети", "Міні-кухня", "Телевізор", "Вид у двір"],
      descriptionParagraphs: [
    ...
    "202": {
      ...
      description: "Студія Standard+ на Strada Coca 15 з видом у бік Дендрарію, Smart TV, кондиціонером, Wi‑Fi та міні-кухнею. 900 MDL.",
      shortDescription: "Сучасна студія Standard+ з видом у напрямку Дендрарію.",
      aboutTitle: "Студія Standard+ біля Дендрарію",
      typeLabel: "Студія Standard+",
      view: "Вид у напрямку Дендрарію",
      features: ["Standard+", "Сучасний євроремонт", "Кондиціонер", "Smart TV", "Wi‑Fi", "Ролети", "Міні-кухня", "Вид у бік Дендрарію"],
      descriptionParagraphs: [
        "ID 202 — оновлена студія на Strada Coca 15, вікна якої орієнтовані в бік зеленої території Дендрарію.",
    ...
    "203": {
      ...
      description: "Premium-студія на Strada Coca 15 із сучасним інтер’єром, видом у бік Дендрарію, Smart TV, Wi‑Fi та кондиціонером. 1000 MDL.",
      shortDescription: "Виразна Premium-студія з цілісним сучасним інтер’єром і видом у бік Дендрарію.",
      aboutTitle: "Premium-студія ID 203 на Strada Coca 15",
    ...
    "204": {
      ...
      description: "Світла студія Premium на Strada Coca 15 з видом у бік Дендрарію, кондиціонером, Smart TV, Wi‑Fi та міні-кухнею. 1000 MDL.",
    ...
    "205": {
      address: "Strada Mitropolit Varlaam 50, Кишинів",
      title: "Апартамент у двоповерховій будівлі — ID 205",
      description: "Окремий апартамент Standard+ у двоповерховій будівлі на Strada Mitropolit Varlaam 50. Новий інтер’єр, 1100 MDL за добу.",
      shortDescription: "Окремий апартамент із новим інтер’єром у двоповерховій будівлі, поділеній на самостійні апартаменти.",
      aboutTitle: "Окремий апартамент на Strada Mitropolit Varlaam 50",
      typeLabel: "Окремий апартамент",
      view: "Окремий апартамент у двоповерховій будівлі",
      features: ["Standard+", "Окремий апартамент", "Двоповерхова будівля", "Новий сучасний інтер’єр", "Підготовлений для подобового проживання"],
      descriptionParagraphs: [
  ...
  cs: {
    "201": {
      ...
      title: "Studio Standard+ v ulici Coca 15 — ID 201",
      description: "Studio Standard+ v ulici Coca 15 s výhledem do dvora, klimatizací, Wi‑Fi, roletami a kuchyňským koutem. 800 MDL za noc.",
      shortDescription: "Čerstvě renovované studio s klidným výhledem do dvora a praktickým vybavením.",
      aboutTitle: "Klidné studio Standard+ v ulici Coca 15",
      typeLabel: "Studio Standard+",
      view: "Výhled do dvora",
      features: ["Standard+", "Moderní rekonstrukce", "Klimatizace", "Wi‑Fi", "Rolety", "Kuchyňský kout", "Televize", "Výhled do dvora"],
      descriptionParagraphs: [
    ...
    "202": {
      ...
      description: "Studio Standard+ v ulici Coca 15 s výhledem směrem k Dendrariu, Smart TV, klimatizací, Wi‑Fi a kuchyňským koutem. 900 MDL.",
      shortDescription: "Moderní studio Standard+ s výhledem směrem k parku Dendrarium.",
      aboutTitle: "Studio Standard+ poblíž Dendraria",
      typeLabel: "Studio Standard+",
      view: "Výhled směrem k Dendrariu",
      features: ["Standard+", "Moderní rekonstrukce", "Klimatizace", "Smart TV", "Wi‑Fi", "Rolety", "Kuchyňský kout", "Výhled k Dendrariu"],
      descriptionParagraphs: [
    ...
    "205": {
      ...
      description: "Samostatný apartmán Standard+ ve dvoupodlažním objektu v ulici Mitropolit Varlaam 50. Nový interiér, 1100 MDL za noc.",
      ...
      features: ["Standard+", "Samostatný apartmán", "Dvoupodlažní objekt", "Nový moderní interiér", "Připraveno pro krátkodobé pobyty"],
      descriptionParagraphs: [
