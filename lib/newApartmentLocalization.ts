...
const newApartmentCopy: Record<Language, Record<string, ApartmentCopy>> = {
  ru: {
    ...
    "203": {
      ...
      description: "Премиум-студия на ул. Кока, 15 с современным интерьером, видом в сторону Дендрария, Smart TV, Wi‑Fi и кондиционером. 1000 MDL в сутки.",
    ...
    "204": {
      ...
      description: "Светлая студия Премиум на ул. Кока, 15 с видом в сторону Дендрария, кондиционером, Smart TV, Wi‑Fi и мини-кухней. 1000 MDL в сутки.",
  ...
  ro: {
    "201": {
      ...
      description: "Garsonieră Confort pe Strada Coca 15, cu vedere spre curte, aer condiționat, Wi‑Fi, rulouri și mini-bucătărie. 800 MDL pe noapte.",
    ...
    "202": {
      ...
      description: "Garsonieră Confort pe Strada Coca 15, cu vedere spre Dendrariu, Smart TV, aer condiționat, Wi‑Fi și mini-bucătărie. 900 MDL.",
    ...
    "205": {
      ...
      description: "Apartament separat Confort într-o clădire cu două niveluri pe Strada Mitropolit Varlaam 50. Interior nou, 1100 MDL pe noapte.",
  ...
  uk: {
    "201": {
      ...
      description: "Студія Комфорт на вул. Кока, 15 з видом у двір, кондиціонером, Wi‑Fi, ролетами та міні-кухнею. 800 MDL за добу.",
    ...
    "202": {
      ...
      description: "Студія Комфорт на вул. Кока, 15 з видом у бік Дендрарію, Smart TV, кондиціонером, Wi‑Fi та міні-кухнею. 900 MDL.",
    ...
    "203": {
      ...
      description: "Преміум-студія на вул. Кока, 15 із сучасним інтер’єром, видом у бік Дендрарію, Smart TV, Wi‑Fi та кондиціонером. 1000 MDL.",
    ...
    "204": {
      ...
      description: "Світла студія Преміум на вул. Кока, 15 з видом у бік Дендрарію, кондиціонером, Smart TV, Wi‑Fi та міні-кухнею. 1000 MDL.",
    ...
    "205": {
      ...
      description: "Окремий апартамент Комфорт у двоповерховій будівлі на вул. Митрополит Варлаам, 50. Новий інтер’єр, 1100 MDL за добу.",
  ...
  cs: {
    "201": {
      ...
      description: "Komfortní studio v ulici Coca 15 s výhledem do dvora, klimatizací, Wi‑Fi, roletami a kuchyňským koutem. 800 MDL za noc.",
    ...
    "202": {
      ...
      description: "Komfortní studio v ulici Coca 15 s výhledem směrem k Dendrariu, Smart TV, klimatizací, Wi‑Fi a kuchyňským koutem. 900 MDL.",
    ...
    "203": {
      ...
      description: "Prémiové studio v ulici Coca 15 s moderním interiérem, výhledem směrem k Dendrariu, Smart TV, Wi‑Fi a klimatizací. 1000 MDL.",
    ...
    "204": {
      ...
      description: "Světlé Prémiové studio v ulici Coca 15 s výhledem směrem k Dendrariu, klimatizací, Smart TV, Wi‑Fi a kuchyňským koutem. 1000 MDL.",
    ...
    "205": {
      ...
      description: "Samostatný komfortní apartmán ve dvoupodlažním objektu v ulici Mitropolit Varlaam 50. Nový interiér, 1100 MDL za noc.",
