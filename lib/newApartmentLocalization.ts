...
const newApartmentCopy: Record<Language, Record<string, ApartmentCopy>> = {
  ru: {
    "201": {
      ...
      title: "Студия Standard+ на ул. Кока, 15 — ID 201",
      description: "Студия Standard+ на ул. Кока, 15 в Кишинёве с видом во двор, кондиционером, Wi‑Fi, роллетами и мини-кухней. 800 MDL в сутки.",
      shortDescription: "Свежая студия с видом во двор и практичным оснащением для посуточного проживания.",
      aboutTitle: "Спокойная студия Standard+ на ул. Кока, 15",
    ...
    "202": {
      ...
      description: "Студия Standard+ на ул. Кока, 15 с видом в сторону Дендрария, Smart TV, кондиционером, Wi‑Fi и мини-кухней. 900 MDL в сутки.",
    ...
    "205": {
      ...
      description: "Отдельный апартамент Standard+ в двухэтажном здании на ул. Митрополит Варлаам, 50. Новый интерьер, посуточное проживание, 1100 MDL.",
  ...
  uk: {
    "201": {
      ...
      title: "Студія Standard+ на вул. Кока, 15 — ID 201",
      description: "Студія Standard+ на вул. Кока, 15 з видом у двір, кондиціонером, Wi‑Fi, ролетами та міні-кухнею. 800 MDL за добу.",
      shortDescription: "Оновлена студія зі спокійним видом у двір і практичним оснащенням для подобового проживання.",
      aboutTitle: "Тиха студія Standard+ на вул. Кока, 15",
    ...
    "202": {
      ...
      description: "Студія Standard+ на вул. Кока, 15 з видом у бік Дендрарію, Smart TV, кондиціонером, Wi‑Fi та міні-кухнею. 900 MDL.",
    ...
    "205": {
      ...
      description: "Окремий апартамент Standard+ у двоповерховій будівлі на вул. Митрополит Варлаам, 50. Новий інтер’єр, 1100 MDL за добу.",
