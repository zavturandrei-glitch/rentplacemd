...
export const translations = {
  ru: {
    ...
    hero: {
      ...
      find: "Найти",
      availableIds:
        "Доступные ID: 5, 8, 9, 10, 11, 12, 13, 14, 20, 21, 22, 23, 37, 38, 42, 110, 111, 112, 371.",
      notFound:
  ...
  ro: {
    ...
    hero: {
      ...
      find: "Caută",
      availableIds:
        "ID-uri disponibile: 5, 8, 9, 10, 11, 12, 13, 14, 20, 21, 22, 23, 37, 38, 42, 110, 111, 112, 371.",
      notFound:
  ...
  en: {
    ...
    hero: {
      ...
      find: "Find",
      availableIds:
        "Available IDs: 5, 8, 9, 10, 11, 12, 13, 14, 20, 21, 22, 23, 37, 38, 42, 110, 111, 112, 371.",
  ...
  uk: {
    ...
    hero: {
      ...
      find: "Знайти",
      availableIds:
        "Доступні ID: 5, 8, 9, 10, 11, 12, 13, 14, 20, 21, 22, 23, 37, 38, 42, 110, 111, 112, 371.",
      notFound:
  ...
  cs: {
    ...
    hero: {
      ...
      find: "Najít",
      availableIds:
        "Dostupná ID: 5, 8, 9, 10, 11, 12, 13, 14, 20, 21, 22, 23, 37, 38, 42, 110, 111, 112, 371.",
      notFound:
