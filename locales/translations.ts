...
export const translations = {
  ru: {
    common: {
      ...
      moreThan12: "Более {count}\nквартир",
      noMiddlemen: "Прямая связь\nс RentPlaceMD",
      details: "Подробнее",
    ...
    hero: {
      ...
      subtitle: "{count} квартир • 7 адресов в Кишинёве • Центр города • 24/7",
    ...
    benefits: {
      ...
      items: [
        ...
        {
          icon: "🏠",
          title: "Более {count} квартир",
          text: "Можно подобрать вариант под 1, 2, 3, 4 или 5 гостей.",
        },
        {
          icon: "🛡️",
          title: "Прямая связь с RentPlaceMD",
    ...
    footer: {
      ...
      moreThan12Apartments: "Более {count} квартир",
      checkin247: "Заселение 24/7",
      noMiddlemen: "Прямая связь с RentPlaceMD",
    },
  },
  ...
  ro: {
    common: {
      ...
      center: "Centrul\norașului",
      checkin247: "Cazare\n24/7",
      moreThan12: "Peste {count}\napartamente",
      noMiddlemen: "Contact direct\ncu RentPlaceMD",
      details: "Detalii",
    ...
    hero: {
      ...
      subtitle:
        "{count} apartamente • 7 adrese în Chișinău • Centrul orașului • 24/7",
    ...
    benefits: {
      ...
      items: [
        ...
        {
          icon: "🏠",
          title: "Peste {count} apartamente",
          text: "Putem găsi o variantă pentru 1, 2, 3, 4 sau 5 oaspeți.",
        },
        {
          icon: "🛡️",
          title: "Contact direct cu RentPlaceMD",
    ...
    footer: {
      ...
      moreThan12Apartments: "Peste {count} apartamente",
      checkin247: "Cazare 24/7",
      noMiddlemen: "Contact direct cu RentPlaceMD",
    },
  },
  ...
  en: {
    common: {
      ...
      center: "City\ncenter",
      checkin247: "Check-in\n24/7",
      moreThan12: "More than {count}\napartments",
      noMiddlemen: "Direct contact\nwith RentPlaceMD",
      details: "Details",
    ...
    hero: {
      ...
      subtitle: "{count} apartments • 7 Chisinau addresses • City center • 24/7",
    ...
    benefits: {
      ...
      items: [
        ...
        {
          icon: "🏠",
          title: "More than {count} apartments",
          text: "We can match an option for 1, 2, 3, 4 or 5 guests.",
        },
        {
          icon: "🛡️",
          title: "Direct contact with RentPlaceMD",
    ...
    footer: {
      ...
      moreThan12Apartments: "More than {count} apartments",
      checkin247: "Check-in 24/7",
      noMiddlemen: "Direct contact with RentPlaceMD",
    },
  },
  ...
  uk: {
    common: {
      ...
      moreThan12: "Понад {count}\nквартир",
      noMiddlemen: "Прямий зв’язок\nіз RentPlaceMD",
      details: "Детальніше",
    ...
    hero: {
      ...
      subtitle: "{count} квартир • 7 адрес у Кишиневі • Центр міста • 24/7",
    ...
    benefits: {
      ...
      items: [
        ...
        {
          icon: "🏠",
          title: "Понад {count} квартир",
          text: "Можна підібрати варіант для 1, 2, 3, 4 або 5 гостей.",
        },
        {
          icon: "🛡️",
          title: "Прямий зв’язок із RentPlaceMD",
    ...
    footer: {
      ...
      moreThan12Apartments: "Понад {count} квартир",
      checkin247: "Заселення 24/7",
      noMiddlemen: "Прямий зв’язок із RentPlaceMD",
    },
  },
  ...
  cs: {
    common: {
      ...
      moreThan12: "Více než {count}\napartmánů",
      noMiddlemen: "Přímý kontakt\ns RentPlaceMD",
      details: "Detail",
    ...
    hero: {
      ...
      subtitle: "{count} apartmánů • 7 adres v Kišiněvě • Centrum města • 24/7",
    ...
    benefits: {
      ...
      items: [
        ...
        {
          icon: "🏠",
          title: "Více než {count} apartmánů",
          text: "Vybereme variantu pro 1, 2, 3, 4 nebo 5 hostů.",
        },
        {
          icon: "🛡️",
          title: "Přímý kontakt s RentPlaceMD",
    ...
    footer: {
      ...
      moreThan12Apartments: "Více než {count} apartmánů",
      checkin247: "Ubytování 24/7",
      noMiddlemen: "Přímý kontakt s RentPlaceMD",
    },
  },
} as const;
